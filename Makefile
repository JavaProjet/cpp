...
main: main.o Point.o Entity.o Sprite.o fenetre.o
	g++ -Wall main.o Point.o Entity.o Sprite.o fenetre.o $(LSFML) -o main
	rm *.gch

main.o: main.cpp Sprite.h fenetre.h
	g++ -c -Wall main.cpp Sprite.h fenetre.h $(ISFML)
